...
import { At, Copy, Rocket, Star, Badge, Crown, Telegram, X, Github, Instagram, Mail } from "@lib/icons"
...
import { pfp, userAccount, aftersubmit } from "@lib/atoms"
...
const Portfolio: React.FC = () => {
    ...
    useLayoutEffect(() => {
        if (mateAccount) {
            ...
            const displayChallenges: any[] = challenges.map(c => {
                const currChallengeFromContent = allChallenges?.find(a => a.serial === c.id);
    ...
    }, [mateAccount, mateAccount?.questCompletedByMate, userChallenges.length])
        ...
        <main className="w-5/6 lg:w-4/6 mx-auto py-12 lg:py-14" >
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2" >
                ...
                <Card>
                    ...
                    <CardContent>
                        {mateAccount?.mateRole && <p>{Object.keys(mateAccount.mateRole)[0]}</p>}
                    </CardContent>
                </Card>
