...
2. [alttext](https://github.com/shivamSspirit/S-Sol-tokens)

This is backend plus client code

3. [alttext](https://github.com/shivamSspirit/Solana-tokens-backend)

This is rust solana token program code 

4. [alttext](https://github.com/shivamSspirit/solana-tokens-frontend)
